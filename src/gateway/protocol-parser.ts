import { MessageType, ParsedHeader, ParsedBody } from './types.ts'
...
export function parseHeader(content: string): ParsedHeader | null {
  ...
  const isManagerDirected = type === MessageType.TASK_ASSIGN || type === MessageType.ANSWER || type === MessageType.CONTRACT_UPDATE
