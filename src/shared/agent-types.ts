...
export type CoreDomain = 'api' | 'auth' | 'data' | 'frontend' | 'backend' | 'security' | 'infra' | 'cicd' | 'performance' | 'testing'

export const VALID_ROLES: ReadonlySet<string> = new Set<Role>([
  'manager', 'architect', 'engineer', 'qa', 'devops', 'writer', 'reviewer'
])

export const CORE_DOMAINS: ReadonlySet<string> = new Set<CoreDomain>([
  'api', 'auth', 'data', 'frontend', 'backend', 'security', 'infra', 'cicd', 'performance', 'testing'
])
